			...
			const struct scp_ctrl_reg *scp_ctrl_reg)
{
	...
	pr_debug("SCPSYS-DIAG: init_scp enter\n");
	...
	pr_debug("SCPSYS-DIAG: before domains kcalloc\n");
	...
	pr_debug("SCPSYS-DIAG: before infracfg lookup\n");
	...
	pr_debug("SCPSYS-DIAG: before regulator loop\n");
	for (i = 0; i < num; i++) {
	...
	for (i = 0; i < num; i++) {
		...
		pr_debug("SCPSYS-DIAG: domain %d clk setup\n", i);
	...
	pr_debug("SCPSYS-DIAG: init_scp return\n");
	return scp;
}
