...
#ifndef _PLATFORM_MT6897_CONSYS_REG_OFFSET_H_
#define _PLATFORM_MT6897_CONSYS_REG_OFFSET_H_
...
/* MT6897 的 CONN2AP EMI base remap 寄存器在 conn_host_csr_top（0x18060000），
 * 不在 conn_infra_bus_cr —— 依据厂商 conninfra.ko 的
 * consys_emi_set_remapping_reg_mt6897_gen（CONN_HOST_CSR_TOP_BASE+0x354/0x35C/0x360）。
 */
#define CONN_HOST_CSR_TOP_REG_BASE			(CONN_REG_CONN_HOST_CSR_TOP_ADDR)
...
#endif /* _PLATFORM_MT6897_CONSSY_REG_OFFSET_H_ */
