 ...
 *
 * This file, mt6897_debug_gen.c was automatically generated
...
#include "mt6897_debug_gen.h"
#include "conninfra.h"


void __iomem *vir_addr_consys_dbg_gen_srclkenrc_base_mt6897 = NULL;
void __iomem *vir_addr_consys_dbg_gen_topckgen_base_mt6897 = NULL;
void __iomem *vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897 = NULL;
void __iomem *vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 = NULL;
void __iomem *vir_addr_0x1804c000_mt6897 = NULL;

void consys_debug_init_mt6897_debug_gen(void)
{
	vir_addr_consys_dbg_gen_srclkenrc_base_mt6897 = ioremap(CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR, 0x77C);
	vir_addr_consys_dbg_gen_topckgen_base_mt6897 = ioremap(CONSYS_DBG_GEN_TOPCKGEN_BASE_ADDR, 0x180);
	vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897 = ioremap(CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR, 0x41c);
	vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 = ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_BASE_OFFSET_ADDR, 0xBA4);
	vir_addr_0x1804c000_mt6897 = ioremap(0x1804c000, 0xc);
}

void consys_debug_deinit_mt6897_debug_gen(void)
{
	if (vir_addr_consys_dbg_gen_srclkenrc_base_mt6897)
		iounmap(vir_addr_consys_dbg_gen_srclkenrc_base_mt6897);

	if (vir_addr_consys_dbg_gen_topckgen_base_mt6897)
		iounmap(vir_addr_consys_dbg_gen_topckgen_base_mt6897);

	if (vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897)
		iounmap(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897);

	if (vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897);

	if (vir_addr_0x1804c000_mt6897)
		iounmap(vir_addr_0x1804c000_mt6897);
}

void update_debug_read_info_mt6897_debug_gen(
		struct conn_debug_info_mt6897 *info,
		char *tag,
...
void update_debug_write_info_mt6897_debug_gen(
		struct conn_debug_info_mt6897 *info,
		char *tag,
...
void consys_print_power_debug_dbg_level_0_mt6897_debug_gen(
		int level,
		struct conn_debug_info_mt6897 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
		return;

	memset(pdbg_level_0_info, 0, sizeof(struct conn_debug_info_mt6897));

	if (level < 0)
		return;

	if (!vir_addr_consys_dbg_gen_srclkenrc_base_mt6897) {
		pr_notice("vir_addr_consys_dbg_gen_srclkenrc_base_mt6897(%x) ioremap fail\n",
				CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_topckgen_base_mt6897) {
		pr_notice("vir_addr_consys_dbg_gen_topckgen_base_mt6897(%x) ioremap fail\n",
	...
	/* A0 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_0_info,
	...
	update_debug_read_info_mt6897_debug_gen(pdbg_level_0_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6897 +
	...
	update_debug_read_info_mt6897_debug_gen(pdbg_level_0_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_topckgen_base_mt6897 + 0x180));
...
void consys_print_power_debug_dbg_level_1_mt6897_debug_gen(
		int level,
		struct conn_debug_info_mt6897 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		return;

	memset(pdbg_level_1_info, 0, sizeof(struct conn_debug_info_mt6897));

	if (level < 1)
		return;

	if (!vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897) {
		pr_notice("vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897(%x) ioremap fail\n",
	...
	update_debug_read_info_mt6897_debug_gen(pdbg_level_1_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897 +
...
void consys_print_power_debug_dbg_level_2_mt6897_debug_gen(
		int level,
		struct conn_debug_info_mt6897 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;

	memset(pdbg_level_2_info, 0, sizeof(struct conn_debug_info_mt6897));

	if (level < 2)
		return;

	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897(%x) ioremap fail\n",
	...
	/* C0 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
	...
	update_debug_write_info_mt6897_debug_gen(pdbg_level_2_info,
	...
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			...
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 + 0xB8C));

	/* C17 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"C17", 0x18050000 + 0xB90,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 + 0xB90));

	/* C18 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"C18", 0x18050000 + 0xB94,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 + 0xB94));

	/* C19 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"C19", 0x18050000 + 0xB98,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 + 0xB98));

	/* C20 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"C20", 0x18050000 + 0xB9C,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 + 0xB9C));

	/* C21 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"C21", 0x18050000 + 0xBA0,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 + 0xBA0));

	/* C22 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"C22", 0x18050000 + 0xBA4,
			CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_base_offset_mt6897 + 0xBA4));
...
void consys_print_bus_debug_dbg_level_1_mt6897_debug_gen(
		int level,
		struct conn_debug_info_mt6897 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
	...
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897 +
...
void consys_print_bus_debug_dbg_level_2_mt6897_debug_gen(
		int level,
		struct conn_debug_info_mt6897 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
	...
	if (!vir_addr_0x1804c000_mt6897) {
		pr_notice("vir_addr_0x1804c000_mt6897(%x) ioremap fail\n",
				0x1804c000);
		return;
	}
	...
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"37", 0x1804c000 + 0x4,
			CONSYS_REG_READ(vir_addr_0x1804c000_mt6897 + 0x4));

	/* 38 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
			"38", 0x1804c000 + 0xc,
			CONSYS_REG_READ(vir_addr_0x1804c000_mt6897 + 0xc));
...
void consys_print_bus_slpprot_debug_dbg_level_2_mt6897_debug_gen(
		int level,
		struct conn_debug_info_mt6897 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
...
void consys_print_bus_slpprot_debug_dbg_level_0_mt6897_debug_gen(
		int level,
		struct conn_debug_info_mt6897 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
