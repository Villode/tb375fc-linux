...
/*
 * MediaTek MT6897 pin descriptors.
 *
 * Generated from the vendor TB375FC device tree (pinctrl@10005000 +
 * apirq@11ce0000 `mediatek,pins` matrix). Pins 0-122 have a 1:1 GPIO->EINT
 * line; pins 123-231 have no EINT. Alternate function names are unknown
 * (vendor driver is binary-only), so only the GPIO function is declared —
 * enough for gpiochip + EINT users.
 */
